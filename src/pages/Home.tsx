      ...
      >
        ...
        <div className="pr-2">
          ...
          <a
            ...
            className="w-full mt-4 px-6 py-3 bg-[#25D366]/80 hover:bg-[#20bd5a]/90 text-white rounded-xl font-semibold transition-all hover:scale-[1.02] inline-flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(37,211,102,0.5)] backdrop-blur-md border border-white/20"
          >
...
function ContactForm() {
    ...
    return (
      <div className="text-center py-12">
        ...
        <button
          ...
          className="px-6 py-3 bg-primary-500/80 hover:bg-primary-600/90 text-white rounded-xl font-medium transition-all shadow-[0_0_15px_rgba(147,51,234,0.4)] backdrop-blur-md border border-white/20"
        >
          Отправить ещё
        </button>
      </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <button
        type="submit"
        className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-primary-500/80 hover:bg-primary-600/90 text-white rounded-xl font-semibold text-lg transition-all hover:scale-[1.02] shadow-[0_0_20px_rgba(147,51,234,0.5)] hover:shadow-[0_0_30px_rgba(147,51,234,0.7)] backdrop-blur-md border border-white/20 active:scale-[0.98]"
      >
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="reveal reveal-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <button
                ...
                className="group relative px-8 py-4 bg-primary-500/80 hover:bg-primary-600/90 text-white rounded-2xl font-semibold text-lg transition-all hover:scale-105 shadow-[0_0_20px_rgba(147,51,234,0.5)] hover:shadow-[0_0_30px_rgba(147,51,234,0.7)] backdrop-blur-md border border-white/20 flex items-center gap-2 overflow-hidden"
              >
                ...
                <span className="relative z-10 flex items-center gap-2">Записаться на техосмотр <ArrowDownIcon /></span>
              </button>
              <button
                type="button"
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          <button
                            ...
                            className="relative z-20 cursor-pointer px-5 py-2 bg-primary-500/80 hover:bg-primary-600/90 text-white rounded-xl font-medium transition-all hover:scale-105 pointer-events-auto shadow-[0_0_15px_rgba(147,51,234,0.4)] backdrop-blur-md border border-white/20"
                          >
                            Подробнее
                          </button>
                        </div>
